...
# --- Load C++ Data ---
while not hasattr(js, 'cppData'): pass
...
# Reduce frames for web performance (every 2nd frame)
step = 2
frames = range(0, len(t_cpp), step)
...
# Inject into DOM
display(smp.HTML(html_video), target="plot-div")
